...
public class InputActivity extends AppCompatActivity {
    ...
    private EditText mTitleEdit, mContentEdit,mCategory ; //追加(mCategory)
    private Task mTask;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCategory = (EditText)findViewById(R.id.categoy_text); //追加
        ...
        if (mTask == null) {
            ...
            mCategory.setText(mTask.getCategory()); //追加
    ...
    private void addTask() {
        ...
        String category = mCategory.getText().toString(); //追加
